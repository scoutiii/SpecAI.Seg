...
This document is a centeralized place to describe all the desired funcationality for the SpecAI.Seg package, along with who will be working on each part.
Each section will detail a main component of the code to be implemented, including the desired funcationality/structure of the function so that everything can work together.
