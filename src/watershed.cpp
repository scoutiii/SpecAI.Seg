...
// // [[Rcpp::export]]
// NumericMatrix marker_based_watershed(NumericMatrix gradient_image, NumericMatrix markers) {
//   NumericMatrix marker_image;
//
//   if (markers.isNotNull()) {
//     marker_image = as<NumericMatrix>(markers);
//   } else {
//     marker_image = find_local_minima(gradient_image);
//   }
//
