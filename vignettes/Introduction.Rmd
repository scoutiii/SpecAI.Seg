...
mark_boundaries takes the segmented gradient, an RGB version of the image, and an RGB color vector. It used erosion and dilation to mark the RGB image along the boundaries of the segmented gradient. The color vector can be changed freely, but has a default of yellow (maximum red and green). This function will typically used automatically when plotting an object of class "HSI_seg"
